...
var CleverTap = {
  ...
  /**
   * Manually get the push token on the CleverTap user profile
   * @return {string} - the device token
   * @param {'FCM' | 'GCM'} type - specify CleverTap.GCM or CleverTap.FCM
   */
  getPushToken: function(type = "FCM") {
    const token = CleverTapReact.getPushToken(type);
    return token;
  },
